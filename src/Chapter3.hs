...
peopleInHouse SinglePerson = 1
peopleInHouse TwoPeople = 2
peopleInHouse ThreePeople = 3
peopleInHouse FourPeople = 4
...
buildWalls city =
  let newCastle =
        case cityCastleAndWalls city of
          ...
          -- cases
          Castle s
            | sum (map peopleInHouse (cityHouses city)) >= 10 -> CastleAndWalls s
